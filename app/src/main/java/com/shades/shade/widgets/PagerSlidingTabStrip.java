...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    // private int color_TABBGColore = Color.parseColor("#f4f4f4");//Old
    private int color_TABBGColore = Color.parseColor("#DADADA");// New
    private int color_TextLightGrey = Color.parseColor("#939393");
    private int tab_selectedTextColor = Color.parseColor("#981e61");
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs,
        ...
        try {
            tabTextSize = (int) context.getResources().getInteger(R.dimen.sp_mediumx);
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        int textPrimaryColor = a.getColor(TEXT_COLOR_PRIMARY, getResources().getColor(R.color.colorPrimary));
        ...
        int coloumnCount = a.getInt(
                R.styleable.PagerSlidingTabStrip_pstsTabsColoumnCount, 0);
        tab_selectedTextColor = getResources().getColor(
                R.color.textColor_signin_tiitle);
        ...
        tabTextColor = colorStateList == null ? getColorStateList(Color.argb(
                ...
                : colorStateList;
        tabTextColor = getColorStateList(color_TextLightGrey);
        // tabTextColorSelected = tabTextColorSelected == null ?
        // getColorStateList(textPrimaryColor) : tabTextColorSelected;
        tabTextColorSelected = getColorStateList(tab_selectedTextColor);
        ...
        defaultTabLayoutParams = new LinearLayout.LayoutParams(Width,
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if (pager.getAdapter() instanceof CustomTabProvider) {
                ...
                tabView = LayoutInflater.from(getContext()).inflate(
                        R.layout.inflate_tabpager_tab, this, false);
            }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // draw box
        if (isDrawBox) {
            rectPaint.setColor(color_TABBGColore);
            canvas.drawRect(lines.first + paddingLeft, 0, lines.second
    ...
    public void setDrawBox(boolean isDrawBox_) {
        this.isDrawBox = isDrawBox_;
    }
